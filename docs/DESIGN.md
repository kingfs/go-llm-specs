...
-   **Single Source of Truth**: `models/**/*.yaml` 是人工维护的最高优先级事实源；OpenRouter 负责广泛发现，官方来源和 AI 自动化只能填充空字段或生成待审核建议。
...
// Identical registry inputs always produce identical output.
    ...
    steps:
      ...
      - name: Commit and Push
        ...
        run: |
          ...
          git commit -m "feat(data): auto-update model registry"
          git push
