...
func init() {
	staticRegistry = map[string]*modelData{
		...
		"cohere/command-a-plus-05-2026-bf16": {
			...
			SummaryVal:      "Command A+ is an open source Sparse Mixture-of-Experts model with 25B active and 218B total parameters, optimized for agentic, multilingual, and reasoning-heavy tasks, supporting text and image inputs with 48 languages.",
		...
		"stealth/ox-alpha": {
			...
			FamilyVal:       "Ox",
			SeriesVal:       "Ox Alpha",
			SummaryVal:      "Ox Alpha is a reasoning model designed for coding, sustained agentic work, and production workloads.",
		...
		"tencent/hy-mt2-30b-a3b": {
			...
			SummaryVal:      "Hy-MT2-30B-A3B is Tencent's flagship translation model in the Hy-MT2 family.",
		...
		"thinkingmachines/inkling": {
			...
			AliasList:       []string{"inkling", "thinkingmachines/inkling:batch"},
		},
		"thinkingmachines/inkling-small": {
			...
			MaxOutputVal:    262144,
			FeaturesVal:     CapChat | CapFunctionCall | ModalityAudioIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"inkling-small"},
		},
