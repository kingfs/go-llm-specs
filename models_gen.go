...
// Generated at: 2026-07-14T04:38:09Z
...
func init() {
	staticRegistry = map[string]*modelData{
		...
		"kwaipilot/kat-coder-air-v2.5": {
			...
			SummaryVal:    "",
			TagList:       []string{ "chat", "coding", "kat", "structured-output", "tool-use" },
			ContextLenVal: 256000,
			MaxOutputVal:  80000,
			FeaturesVal:   CapChat | CapFunctionCall | CapJsonMode | ModalityTextIn | ModalityTextOut,
		...
		"kwaipilot/kat-coder-pro-v2.5": {
			...
			SummaryVal:    "",
			TagList:       []string{ "chat", "coding", "kat", "pro", "structured-output", "tool-use" },
			ContextLenVal: 256000,
			MaxOutputVal:  80000,
			FeaturesVal:   CapChat | CapFunctionCall | CapJsonMode | ModalityTextIn | ModalityTextOut,
