...
// Generated at: 2026-04-09T04:23:10Z
...
func init() {
	staticRegistry = map[string]*modelData{
		...
		"anthropic/claude-opus-4.6-fast": {
			...
			SummaryVal:    "Fast-mode variant of [Opus 4.",
		...
		"arcee-ai/trinity-large-thinking": {
			...
			SummaryVal:    "Trinity Large Thinking is a powerful open source reasoning model from the team at Arcee AI.",
		...
		"google/gemma-4-26b-a4b-it": {
			...
			SummaryVal:    "Gemma 4 26B A4B IT is an instruction-tuned Mixture-of-Experts (MoE) model from Google DeepMind.",
		...
		"google/gemma-4-31b-it": {
			...
			SummaryVal:    "Gemma 4 31B Instruct is Google DeepMind's 30.",
			TagList:       []string{ "chat", "coding", "gemma", "reasoning", "structured-output", "thinking", "tool-use", "video-input", "vision" },
			ContextLenVal: 262144,
			MaxOutputVal:  131072,
			FeaturesVal:   CapChat | CapFunctionCall | CapJsonMode | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
		...
		"google/lyria-3-clip-preview": {
			...
			SummaryVal:    "30 second duration clips are priced at $0.",
		...
		"google/lyria-3-pro-preview": {
			...
			SummaryVal:    "Full-length songs are priced at $0.",
		...
		"kwaipilot/kat-coder-pro-v2": {
			...
			SummaryVal:    "KAT-Coder-Pro V2 is the latest high-performance model in KwaiKAT’s KAT-Coder series, designed for complex enterprise-grade software engineering and SaaS integration.",
			TagList:       []string{ "agent", "chat", "coding", "kat", "pro", "structured-output", "tool-use" },
			ContextLenVal: 256000,
			MaxOutputVal:  80000,
			FeaturesVal:   CapChat | CapFunctionCall | CapJsonMode | ModalityTextIn | ModalityTextOut,
		...
		"rekaai/reka-edge": {
			...
			FamilyVal:     "Reka",
			SeriesVal:     "Reka Edge",
			SummaryVal:    "Reka Edge is an extremely efficient 7B multimodal vision-language model that accepts image/video+text inputs and generates text outputs.",
			TagList:       []string{ "agent", "chat", "coding", "reka", "structured-output", "tool-use", "video-input", "vision" },
			ContextLenVal: 16384,
			MaxOutputVal:  16384,
			FeaturesVal:   CapChat | CapFunctionCall | CapJsonMode | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
		...
		"rekaai/reka-flash-3": {
			...
			FamilyVal:     "Flash",
			SeriesVal:     "Flash 3",
			SummaryVal:    "Reka Flash 3 is a general-purpose, instruction-tuned large language model with 21 billion parameters, developed by Reka.",
