...
func init() {
	staticRegistry = map[string]*modelData{
		...
		"deepseek/deepseek-v4-flash-0731": {
			...
			SummaryVal:      "DeepSeek V4 Flash 0731 is a sparse mixture-of-experts model from DeepSeek, with 13B active parameters out of 284B total.",
		...
		"thinkingmachines/inkling-small": {
			...
			SummaryVal:      "Inkling Small is an open-weight multimodal mixture-of-experts model from Thinking Machines Lab, with 12B active parameters out of 276B total.",
