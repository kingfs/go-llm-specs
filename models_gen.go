...
func init() {
	staticRegistry = map[string]*modelData{
		...
		"anthropic/claude-fable-5:batch": {
			IDVal:           "anthropic/claude-fable-5:batch",
			NameVal:         "Anthropic: Claude Fable 5 (batch)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Claude Fable 5 is a Mythos-class model from Anthropic, built for autonomous knowledge work and coding. It supports text, image, and file inputs with text output, with reasoning support and...",
			DescCNVal:       "Claude Fable 5 是 Anthropic 的神话级模型，旨在进行自主知识工作和编码。支持文本、图像和文件输入，输出文本，具备推理支持和...",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Fable 5 (batch)",
			SummaryVal:      "Claude Fable 5 是 Anthropic 的神话级模型，旨在进行自主知识工作和编码。",
			TagList:         []string{"agent", "chat", "claude", "coding", "file-input", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1000000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-fable-5:batch"},
		},
		...
		"anthropic/claude-haiku-4.5:batch": {
			IDVal:           "anthropic/claude-haiku-4.5:batch",
			NameVal:         "Anthropic: Claude Haiku 4.5 (batch)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Claude Haiku 4.5 is Anthropic’s fastest and most efficient model, delivering near-frontier intelligence at a fraction of the cost and latency of larger Claude models. Matching Claude Sonnet 4’s performance...",
			DescCNVal:       "Claude Haiku 4.5 是 Anthropic 性能最快、效率最高的模型，能够以较低的成本和延迟提供接近前沿的智能。与 Claude Sonnet 4 的性能相匹配...",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Haiku 4.5 (batch)",
			SummaryVal:      "Claude Haiku 4.",
			TagList:         []string{"chat", "claude", "fast", "file-input", "structured-output", "tool-use", "vision"},
			ContextLenVal:   200000,
			MaxOutputVal:    64000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-haiku-4.5:batch"},
		},
		...
		"anthropic/claude-opus-4.1:batch": {
			IDVal:           "anthropic/claude-opus-4.1:batch",
			NameVal:         "Anthropic: Claude Opus 4.1 (batch)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Claude Opus 4.1 is an updated version of Anthropic’s flagship model, offering improved performance in coding, reasoning, and agentic tasks. It achieves 74.5% on SWE-bench Verified and shows notable gains...",
			DescCNVal:       "Claude Opus 4.1 是 Anthropic 的旗舰模型的更新版本，在编码、推理和代理任务中提供了更好的性能。在 SWE-bench Verified 上取得 74.5% 的成绩，并显示出显著的提升...",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Opus 4.1 (batch)",
			SummaryVal:      "Claude Opus 4.",
			TagList:         []string{"agent", "chat", "claude", "coding", "file-input", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   200000,
			MaxOutputVal:    32000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-opus-4.1:batch"},
		},
		...
		"anthropic/claude-opus-4.5:batch": {
			IDVal:           "anthropic/claude-opus-4.5:batch",
			NameVal:         "Anthropic: Claude Opus 4.5 (batch)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Claude Opus 4.5 is Anthropic’s frontier reasoning model optimized for complex software engineering, agentic workflows, and long-horizon computer use. It offers strong multimodal capabilities, competitive performance across real-world coding and...",
			DescCNVal:       "Claude Opus 4.5 是 Anthropic 的前沿推理模型，针对复杂软件工程、代理工作流程和长时间计算机使用进行了优化。提供强大的多模态能力，在现实世界的编码中表现竞争力...",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Opus 4.5 (batch)",
			SummaryVal:      "Claude Opus 4.",
			TagList:         []string{"agent", "chat", "claude", "coding", "file-input", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   200000,
			MaxOutputVal:    64000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-opus-4.5:batch"},
		},
		...
		"anthropic/claude-opus-4.6:batch": {
			IDVal:           "anthropic/claude-opus-4.6:batch",
			NameVal:         "Anthropic: Claude Opus 4.6 (batch)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Opus 4.6 is Anthropic’s strongest model for coding and long-running professional tasks. It is built for agents that operate across entire workflows rather than single prompts, making it especially effective...",
			DescCNVal:       "Opus 4.6 是 Anthropic 最强大的编码和长时间专业任务模型。它旨在用于跨整个工作流程而非单一提示的代理，因此在实施方面特别有效...",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Opus 4.6 (batch)",
			SummaryVal:      "Opus 4.",
			TagList:         []string{"agent", "chat", "claude", "coding", "file-input", "pro", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1000000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-opus-4.6:batch"},
		},
		...
		"anthropic/claude-opus-4.7:batch": {
			IDVal:           "anthropic/claude-opus-4.7:batch",
			NameVal:         "Anthropic: Claude Opus 4.7 (batch)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Opus 4.7 is the next generation of Anthropic's Opus family, built for long-running, asynchronous agents. Building on the coding and agentic strengths of Opus 4.6, it delivers stronger performance on...",
			DescCNVal:       "Opus 4.7 是 Anthropic Opus 系列的下一代模型，专为长时间运行的异步代理而构建。在 Opus 4.6 的编码和代理优势基础上，提供更强的性能...",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Opus 4.7 (batch)",
			SummaryVal:      "Opus 4.",
			TagList:         []string{"agent", "chat", "claude", "coding", "file-input", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1000000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-opus-4.7:batch"},
		},
		...
		"anthropic/claude-opus-4.8:batch": {
			IDVal:           "anthropic/claude-opus-4.8:batch",
			NameVal:         "Anthropic: Claude Opus 4.8 (batch)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Claude Opus 4.8 is Anthropic's most capable generally available model in the Opus family. It supports text, image, and file inputs with text output, with reasoning support and a 1M-token...",
			DescCNVal:       "Claude Opus 4.8 是 Anthropic 在 Opus 系列中最强大的通用可用模型。支持文本、图像和文件输入，输出文本，具备推理支持和 1M 代币...",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Opus 4.8 (batch)",
			SummaryVal:      "Claude Opus 4.",
			TagList:         []string{"chat", "claude", "file-input", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1000000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-opus-4.8:batch"},
		},
		"anthropic/claude-opus-5": {
			...
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-opus-5"},
		},
		"anthropic/claude-opus-5-fast": {
			IDVal:           "anthropic/claude-opus-5-fast",
			NameVal:         "Claude Opus 5 (Fast)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Fast-mode variant of [Opus 5](/anthropic/claude-opus-5) - identical capabilities with higher output speed at 2x pricing relative to regular Opus 5.\n\nLearn more in Anthropic's docs: https://platform.claude.com/docs/en/build-with-claude/fast-mode",
			DescCNVal:       "[Opus 5](/anthropic/claude-opus-5) 的快速模式变体 - 具备相同能力，但输出速度更快，价格为常规 Opus 5 的 2 倍。\n\n更多信息请参见 Anthropic 的文档：https://platform.claude.com/docs/en/build-with-claude/fast-mode",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Opus 5 (Fast)",
			SummaryVal:      "[Opus 5](/anthropic/claude-opus-5) 的快速模式变体 - 具备相同能力，但输出速度更快，价格为常规 Opus 5 的 2 倍。",
			TagList:         []string{"chat", "claude", "coding", "fast", "file-input", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1000000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-opus-5-fast"},
		},
		"anthropic/claude-opus-5:batch": {
			IDVal:           "anthropic/claude-opus-5:batch",
			NameVal:         "Claude Opus 5 (batch)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			...
			DescCNVal:       "",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Opus 5 (batch)",
			SummaryVal:      "Claude Opus 5 is Anthropic’s flagship model for demanding reasoning, coding, and long-horizon agentic work.",
			TagList:         []string{"agent", "chat", "claude", "coding", "file-input", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1000000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-opus-5:batch"},
		},
		...
		"anthropic/claude-sonnet-4.5:batch": {
			IDVal:           "anthropic/claude-sonnet-4.5:batch",
			NameVal:         "Anthropic: Claude Sonnet 4.5 (batch)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Claude Sonnet 4.5 is Anthropic’s most advanced Sonnet model to date, optimized for real-world agents and coding workflows. It delivers state-of-the-art performance on coding benchmarks such as SWE-bench Verified, with...",
			DescCNVal:       "Claude Sonnet 4.5 是迄今为止 Anthropic 最先进的 Sonnet 模型，针对现实世界的代理和编码工作流程进行了优化。在编码基准测试如 SWE-bench Verified 上提供了最先进的性能，具有...",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Sonnet 4.5 (batch)",
			SummaryVal:      "Claude Sonnet 4.",
			TagList:         []string{"agent", "chat", "claude", "coding", "file-input", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1000000,
			MaxOutputVal:    64000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-sonnet-4.5:batch"},
		},
		...
		"anthropic/claude-sonnet-4.6:batch": {
			IDVal:           "anthropic/claude-sonnet-4.6:batch",
			NameVal:         "Anthropic: Claude Sonnet 4.6 (batch)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Sonnet 4.6 is Anthropic's most capable Sonnet-class model yet, with frontier performance across coding, agents, and professional work. It excels at iterative development, complex codebase navigation, end-to-end project management with...",
			DescCNVal:       "",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Sonnet 4.6 (batch)",
			SummaryVal:      "Sonnet 4.",
			TagList:         []string{"agent", "chat", "claude", "coding", "file-input", "pro", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1000000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-sonnet-4.6:batch"},
		},
		...
		"anthropic/claude-sonnet-5:batch": {
			IDVal:           "anthropic/claude-sonnet-5:batch",
			NameVal:         "Anthropic: Claude Sonnet 5 (batch)",
			ProviderVal:     "Anthropic",
			DeveloperVal:    "anthropic",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Sonnet 5 is Anthropic's most capable Sonnet-class model, with frontier performance across coding, agents, and professional work. It supports adaptive thinking with selectable reasoning effort levels (low, medium, high, max,...",
			DescCNVal:       "Sonnet 5 是 Anthropic 功能最强大的 Sonnet 级模型，在编码、代理和专业工作中实现了前沿性能。支持可选的推理努力水平（低、中、高、最大），具备自适应思维...",
			FamilyVal:       "Claude",
			SeriesVal:       "Claude Sonnet 5 (batch)",
			SummaryVal:      "Sonnet 5 是 Anthropic 功能最强大的 Sonnet 级模型，在编码、代理和专业工作中实现了前沿性能。",
			TagList:         []string{"agent", "chat", "claude", "coding", "file-input", "pro", "reasoning", "structured-output", "thinking", "tool-use", "vision"},
			ContextLenVal:   1000000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"claude-sonnet-5:batch"},
		},
		...
		"cognitivecomputations/dolphin-mistral-24b-venice-edition": {
			...
			MaxOutputVal:    8192,
			FeaturesVal:     CapChat | CapJsonMode | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"dolphin-mistral-24b-venice-edition"},
		},
		...
		"google/gemini-2.5-flash-lite:batch": {
			IDVal:           "google/gemini-2.5-flash-lite:batch",
			NameVal:         "Google: Gemini 2.5 Flash Lite (batch)",
			ProviderVal:     "Google",
			DeveloperVal:    "google",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Gemini 2.5 Flash-Lite is a lightweight reasoning model in the Gemini 2.5 family, optimized for ultra-low latency and cost efficiency. It offers improved throughput, faster token generation, and better performance...",
			DescCNVal:       "Gemini 2.5 Flash-Lite 是 Gemini 2.5 系列中的轻量级推理模型，针对超低延迟和成本效率进行了优化。提供更高的吞吐量，更快的代币生成，以及更好的性能...",
			FamilyVal:       "Gemini",
			SeriesVal:       "Gemini 2.5 Flash Lite (batch)",
			SummaryVal:      "Gemini 2.",
			TagList:         []string{"audio-input", "chat", "fast", "file-input", "gemini", "mini", "reasoning", "structured-output", "tool-use", "video-input", "vision"},
			ContextLenVal:   1048576,
			MaxOutputVal:    65535,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityAudioIn | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"gemini-2.5-flash-lite:batch"},
		},
		...
		"google/gemini-2.5-flash:batch": {
			IDVal:           "google/gemini-2.5-flash:batch",
			NameVal:         "Google: Gemini 2.5 Flash (batch)",
			ProviderVal:     "Google",
			DeveloperVal:    "google",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Gemini 2.5 Flash is Google's state-of-the-art workhorse model, specifically designed for advanced reasoning, coding, mathematics, and scientific tasks. It includes built-in \"thinking\" capabilities, enabling it to provide responses with greater...",
			DescCNVal:       "Gemini 2.5 Flash 是谷歌的先进工作模型，专门设计用于高级推理、编码、数学和科学任务。它具有内置的“思考”能力，使其能提供更好的响应...",
			FamilyVal:       "Gemini",
			SeriesVal:       "Gemini 2.5 Flash (batch)",
			SummaryVal:      "Gemini 2.",
			TagList:         []string{"audio-input", "chat", "coding", "file-input", "gemini", "mini", "pro", "reasoning", "structured-output", "tool-use", "video-input", "vision"},
			ContextLenVal:   1048576,
			MaxOutputVal:    65535,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityAudioIn | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"gemini-2.5-flash:batch"},
		},
		...
		"google/gemini-2.5-pro:batch": {
			IDVal:           "google/gemini-2.5-pro:batch",
			NameVal:         "Google: Gemini 2.5 Pro (batch)",
			ProviderVal:     "Google",
			DeveloperVal:    "google",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Gemini 2.5 Pro is Google’s state-of-the-art AI model designed for advanced reasoning, coding, mathematics, and scientific tasks. It employs “thinking” capabilities, enabling it to reason through responses with enhanced accuracy...",
			DescCNVal:       "Gemini 2.5 Pro 是谷歌的先进 AI 模型，专门设计用于高级推理、编码、数学和科学任务。它采用“思考”能力，使其在响应中具有更高的准确性...",
			FamilyVal:       "Gemini",
			SeriesVal:       "Gemini 2.5 Pro (batch)",
			SummaryVal:      "Gemini 2.",
			TagList:         []string{"audio-input", "chat", "coding", "file-input", "gemini", "mini", "pro", "reasoning", "structured-output", "tool-use", "video-input", "vision"},
			ContextLenVal:   1048576,
			MaxOutputVal:    65536,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityAudioIn | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"gemini-2.5-pro:batch"},
		},
		...
		"google/gemini-3-flash-preview:batch": {
			IDVal:           "google/gemini-3-flash-preview:batch",
			NameVal:         "Google: Gemini 3 Flash Preview (batch)",
			ProviderVal:     "Google",
			DeveloperVal:    "google",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Gemini 3 Flash Preview is a high speed, high value thinking model designed for agentic workflows, multi turn chat, and coding assistance. It delivers near Pro level reasoning and tool...",
			DescCNVal:       "Gemini 3 Flash Preview 是一种高速、高价值的思维模型，设计用于代理工作流程、多轮对话和编程辅助。它提供接近专业级的推理和工具...",
			FamilyVal:       "Gemini",
			SeriesVal:       "Gemini 3 Flash Preview (batch)",
			SummaryVal:      "Gemini 3 Flash Preview 是一种高速、高价值的思维模型，设计用于代理工作流程、多轮对话和编程辅助。",
			TagList:         []string{"agent", "audio-input", "chat", "coding", "file-input", "gemini", "mini", "preview", "pro", "reasoning", "structured-output", "thinking", "tool-use", "video-input", "vision"},
			ContextLenVal:   1048576,
			MaxOutputVal:    65535,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityAudioIn | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"gemini-3-flash-preview:batch"},
		},
		...
		"google/gemini-3.1-flash-lite:batch": {
			IDVal:           "google/gemini-3.1-flash-lite:batch",
			NameVal:         "Google: Gemini 3.1 Flash Lite (batch)",
			ProviderVal:     "Google",
			DeveloperVal:    "google",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Gemini 3.1 Flash Lite is Google’s GA high-efficiency multimodal model optimized for low-latency, high-volume workloads. It supports text, image, video, audio, and PDF inputs, and is designed for lightweight agentic...",
			DescCNVal:       "Gemini 3.1 Flash Lite 是谷歌的高效多模态模型，优化用于低延迟、高负载的工作量。它支持文本、图像、视频、音频和 PDF 输入，设计用于轻量化代理...",
			FamilyVal:       "Gemini",
			SeriesVal:       "Gemini 3.1 Flash Lite (batch)",
			SummaryVal:      "Gemini 3.",
			TagList:         []string{"agent", "audio-input", "chat", "coding", "file-input", "gemini", "mini", "structured-output", "tool-use", "video-input", "vision"},
			ContextLenVal:   1048576,
			MaxOutputVal:    65536,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityAudioIn | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"gemini-3.1-flash-lite:batch"},
		},
		...
		"google/gemini-3.1-pro-preview:batch": {
			IDVal:           "google/gemini-3.1-pro-preview:batch",
			NameVal:         "Google: Gemini 3.1 Pro Preview (batch)",
			ProviderVal:     "Google",
			DeveloperVal:    "google",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Gemini 3.1 Pro Preview is Google’s frontier reasoning model, delivering enhanced software engineering performance, improved agentic reliability, and more efficient token usage across complex workflows. Building on the multimodal foundation...",
			DescCNVal:       "Gemini 3.1 Pro Preview 是谷歌的前沿推理模型，提供增强的软件工程性能、更高的代理可靠性和跨复杂工作流程更有效的令牌使用。建立在多模态基础上...",
			FamilyVal:       "Gemini",
			SeriesVal:       "Gemini 3.1 Pro Preview (batch)",
			SummaryVal:      "Gemini 3.",
			TagList:         []string{"agent", "audio-input", "chat", "coding", "file-input", "gemini", "mini", "preview", "pro", "reasoning", "structured-output", "tool-use", "video-input", "vision"},
			ContextLenVal:   1048576,
			MaxOutputVal:    65536,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityAudioIn | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"gemini-3.1-pro-preview:batch"},
		},
		...
		"google/gemini-3.5-flash-lite": {
			...
			MaxOutputVal:    65536,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityAudioIn | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"gemini-3.5-flash-lite"},
		},
		"google/gemini-3.5-flash-lite:batch": {
			IDVal:           "google/gemini-3.5-flash-lite:batch",
			NameVal:         "Google: Gemini 3.5 Flash Lite (batch)",
			ProviderVal:     "Google",
			DeveloperVal:    "google",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Gemini 3.5 Flash Lite is a high-efficiency model from Google with upgraded agentic capabilities. It is suited for subagents that execute focused tasks within complex, multi-agent workflows.",
			DescCNVal:       "Gemini 3.5 Flash Lite 是谷歌的一款高效模型，具备升级的代理能力。它适合在复杂的多代理工作流程中执行专注任务的子代理。",
			FamilyVal:       "Gemini",
			SeriesVal:       "Gemini 3.5 Flash Lite (batch)",
			SummaryVal:      "Gemini 3.",
			TagList:         []string{"agent", "audio-input", "chat", "file-input", "gemini", "mini", "structured-output", "tool-use", "video-input", "vision"},
			ContextLenVal:   1048576,
			MaxOutputVal:    65536,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityAudioIn | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"gemini-3.5-flash-lite:batch"},
		},
		"google/gemini-3.5-flash:batch": {
			IDVal:           "google/gemini-3.5-flash:batch",
			NameVal:         "Google: Gemini 3.5 Flash (batch)",
			ProviderVal:     "Google",
			DeveloperVal:    "google",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Gemini 3.5 Flash is Google's high-efficiency multimodal model, bringing near-Pro level coding and reasoning at Flash-tier cost and speed. It is highly optimized for coding proficiency and parallel agentic execution...",
			DescCNVal:       "Gemini 3.5 Flash 是谷歌的高效多模态模型，以接近专业级的编码和推理能力，在闪电级成本和速度下运行。它高度优化了编码能力和并行代理执行...",
			FamilyVal:       "Gemini",
			SeriesVal:       "Gemini 3.5 Flash (batch)",
			SummaryVal:      "Gemini 3.",
			TagList:         []string{"agent", "audio-input", "chat", "coding", "file-input", "gemini", "mini", "pro", "reasoning", "structured-output", "tool-use", "video-input", "vision"},
			ContextLenVal:   1048576,
			MaxOutputVal:    65536,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityAudioIn | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"gemini-3.5-flash:batch"},
		},
		"google/gemini-3.6-flash": {
			...
			MaxOutputVal:    65536,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityAudioIn | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"gemini-3.6-flash"},
		},
		"google/gemini-3.6-flash:batch": {
			IDVal:           "google/gemini-3.6-flash:batch",
			NameVal:         "Google: Gemini 3.6 Flash (batch)",
			ProviderVal:     "Google",
			DeveloperVal:    "google",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "Gemini 3.6 Flash is a high-efficiency model from Google for coding, agentic workflows, and web and app development. It is designed to produce polished outputs with fewer unnecessary edits and...",
			DescCNVal:       "Gemini 3.6 Flash 是谷歌的一款高效模型，用于编码、代理工作流程以及网页和应用开发。它旨在以更少的多余编辑生成精致输出...",
			FamilyVal:       "Gemini",
			SeriesVal:       "Gemini 3.6 Flash (batch)",
			SummaryVal:      "Gemini 3.",
			TagList:         []string{"agent", "audio-input", "chat", "coding", "file-input", "gemini", "mini", "pro", "structured-output", "tool-use", "video-input", "vision"},
			ContextLenVal:   1048576,
			MaxOutputVal:    65536,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityAudioIn | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"gemini-3.6-flash:batch"},
		},
		...
		"ibm-granite/granite-swash-3b-a600m": {
			...
			SummaryVal:      "3B parameter decoder-only sparse language model with per-layer Sliding Window Attention and learnable attention sinks, trained on open source and proprietary data for general-purpose English tasks.",
		...
		"inclusionai/ling-3.0-flash": {
			...
			MaxOutputVal:    16384,
			FeaturesVal:     CapChat | CapFunctionCall | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"ling-3.0-flash"},
		},
		"inclusionai/ling-3.0-flash:free": {
			IDVal:           "inclusionai/ling-3.0-flash:free",
			NameVal:         "Ling-3.0-flash (free)",
			ProviderVal:     "Inclusionai",
			DeveloperVal:    "Inclusionai",
			OfficialURLVal:  "",
			ModelCardURLVal: "https://huggingface.co/inclusionAI/Ling-3.0-flash",
			DescVal:         "*Ling-3.0-flash* is a *124B-parameter Mixture-of-Experts (MoE) model*, with approximately *5.1B parameters activated per token*. The model is designed with *token efficiency and production-scale agentic inference* as key priorities, enabling developers...",
			DescCNVal:       "*Ling-3.0-flash* 是一个 *124B参数的专家混合模型 (MoE)*，每个token大约激活 *5.1B参数*。该模型的设计重点是 *token效率和生产规模应用推理*，使开发者能够...",
			FamilyVal:       "Ling",
			SeriesVal:       "Ling-3.0-flash (free)",
			SummaryVal:      "*Ling-3.",
			TagList:         []string{"agent", "chat", "free", "ling", "pro", "tool-use"},
			ContextLenVal:   262144,
			MaxOutputVal:    32768,
			FeaturesVal:     CapChat | CapFunctionCall | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"ling-3.0-flash:free"},
		},
		"inclusionai/ling-3.0-tiny:free": {
			IDVal:           "inclusionai/ling-3.0-tiny:free",
			NameVal:         "inclusionAI: Ling 3.0 Tiny (free)",
			ProviderVal:     "Inclusionai",
			DeveloperVal:    "inclusionai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			...
			DescCNVal:       "",
			FamilyVal:       "Ling",
			SeriesVal:       "Ling 3.0 Tiny (free)",
			SummaryVal:      "Ling 3.",
			TagList:         []string{"agent", "chat", "free", "ling", "tool-use"},
			ContextLenVal:   262144,
			MaxOutputVal:    32768,
			FeaturesVal:     CapChat | CapFunctionCall | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"ling-3.0-tiny:free"},
		},
		...
		"minimax/minimax-m3:batch": {
			IDVal:           "minimax/minimax-m3:batch",
			NameVal:         "MiniMax: MiniMax M3 (batch)",
			ProviderVal:     "Minimax",
			DeveloperVal:    "minimax",
			OfficialURLVal:  "",
			ModelCardURLVal: "https://huggingface.co/MiniMaxAI/MiniMax-M3",
			DescVal:         "MiniMax-M3 is a multimodal foundation model from MiniMax. It supports text, image, and video inputs with text output, a 1M-token context window, and is suited for long-horizon agentic work, coding,...",
			DescCNVal:       "MiniMax-M3 是一款来自 MiniMax 的多模态基础模型。它支持文本、图像和视频输入，具备文本输出，1M 令牌上下文窗口，适合于长期的代理工作、编码...",
			FamilyVal:       "Minimax",
			SeriesVal:       "MiniMax M3 (batch)",
			SummaryVal:      "MiniMax-M3 是一款来自 MiniMax 的多模态基础模型。",
			TagList:         []string{"agent", "chat", "coding", "mini", "minimax", "structured-output", "tool-use", "video-input", "vision"},
			ContextLenVal:   524288,
			MaxOutputVal:    0,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityImageIn | ModalityTextIn | ModalityTextOut | ModalityVideoIn | CapMultimodal,
			AliasList:       []string{"minimax-m3:batch"},
		},
		...
		"moonshotai/kimi-k2.7-code:batch": {
			IDVal:           "moonshotai/kimi-k2.7-code:batch",
			NameVal:         "MoonshotAI: Kimi K2.7 Code (batch)",
			ProviderVal:     "Moonshotai",
			DeveloperVal:    "moonshotai",
			OfficialURLVal:  "",
			ModelCardURLVal: "https://huggingface.co/moonshotai/Kimi-K2.7-Code",
			...
			DescCNVal:       "",
			FamilyVal:       "Kimi",
			SeriesVal:       "Kimi K2.7 Code (batch)",
			SummaryVal:      "MoonshotAI: Kimi K2.",
			TagList:         []string{"chat", "coding", "kimi", "pro", "structured-output", "tool-use", "vision"},
			ContextLenVal:   262144,
			MaxOutputVal:    0,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"kimi-k2.7-code:batch"},
		},
		...
		"nvidia/nemotron-3-ultra-550b-a55b:batch": {
			IDVal:           "nvidia/nemotron-3-ultra-550b-a55b:batch",
			NameVal:         "NVIDIA: Nemotron 3 Ultra (batch)",
			ProviderVal:     "Nvidia",
			DeveloperVal:    "nvidia",
			OfficialURLVal:  "",
			ModelCardURLVal: "https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Ultra-550B-A55B-BF16",
			...
			DescCNVal:       "",
			FamilyVal:       "Nemotron",
			SeriesVal:       "Nemotron 3 Ultra (batch)",
			SummaryVal:      "NVIDIA Nemotron 3 Ultra is an open frontier-reasoning and orchestration model from NVIDIA, with 55B active parameters out of 550B total (MoE).",
			TagList:         []string{"chat", "nemotron", "reasoning", "structured-output", "tool-use"},
			ContextLenVal:   512288,
			MaxOutputVal:    0,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"nemotron-3-ultra-550b-a55b:batch"},
		},
		...
		"nvidia/nemotron-cascade-2-30b-a3b": {
			...
			SummaryVal:      "Nemotron-Cascade-2-30B-A3B is an open 30B MoE model with 3B activated parameters delivering strong reasoning and agentic capabilities.",
		...
		"openai/gpt-3.5-turbo:batch": {
			IDVal:           "openai/gpt-3.5-turbo:batch",
			NameVal:         "OpenAI: GPT-3.5 Turbo (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-3.5 Turbo is OpenAI's fastest model. It can understand and generate natural language or code, and is optimized for chat and traditional completion tasks.\n\nTraining data up to Sep 2021.",
			DescCNVal:       "GPT-3.5 Turbo 是 OpenAI 最快的模型。它能理解并生成自然语言或代码，针对聊天和传统补全任务进行了优化。\n\n训练数据更新至 2021 年 9 月。",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-3.5 Turbo (batch)",
			SummaryVal:      "GPT-3.",
			TagList:         []string{"chat", "fast", "gpt", "structured-output", "tool-use", "turbo"},
			ContextLenVal:   16385,
			MaxOutputVal:    4096,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"gpt-3.5-turbo:batch"},
		},
		"openai/gpt-4": {
			IDVal:           "openai/gpt-4",
		...
		"openai/gpt-4-turbo:batch": {
			IDVal:           "openai/gpt-4-turbo:batch",
			NameVal:         "OpenAI: GPT-4 Turbo (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "The latest GPT-4 Turbo model with vision capabilities. Vision requests can now use JSON mode and function calling.\n\nTraining data: up to December 2023.",
			DescCNVal:       "具备视觉功能的最新 GPT-4 Turbo 模型。视觉请求现已支持 JSON 模式和函数调用。\n\n训练数据：更新至 2023 年 12 月。",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-4 Turbo (batch)",
			SummaryVal:      "具备视觉功能的最新 GPT-4 Turbo 模型。",
			TagList:         []string{"chat", "gpt", "structured-output", "tool-use", "turbo", "vision"},
			ContextLenVal:   128000,
			MaxOutputVal:    4096,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-4-turbo:batch"},
		},
		"openai/gpt-4.1": {
		...
		"openai/gpt-4.1-mini:batch": {
			IDVal:           "openai/gpt-4.1-mini:batch",
			NameVal:         "OpenAI: GPT-4.1 Mini (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-4.1 Mini is a mid-sized model delivering performance competitive with GPT-4o at substantially lower latency and cost. It retains a 1 million token context window and scores 45.1% on hard...",
			DescCNVal:       "GPT-4.1 Mini 是一款中型模型，在显著降低延迟和成本的同时，提供了可与 GPT-4o 相媲美的性能。它保留了 100 万 token 的上下文窗口，并在高难度...测试中取得 45.1% 的分数。",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-4.1 Mini (batch)",
			SummaryVal:      "GPT-4.",
			TagList:         []string{"chat", "file-input", "gpt", "mini", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1047576,
			MaxOutputVal:    32768,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-4.1-mini:batch"},
		},
		"openai/gpt-4.1-nano": {
		...
		"openai/gpt-4.1-nano:batch": {
			IDVal:           "openai/gpt-4.1-nano:batch",
			NameVal:         "OpenAI: GPT-4.1 Nano (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "For tasks that demand low latency, GPT‑4.1 nano is the fastest and cheapest model in the GPT-4.1 series. It delivers exceptional performance at a small size with its 1 million...",
			DescCNVal:       "对于需要低延迟的任务，GPT-4.1 nano 是 GPT-4.1 系列中速度最快、成本最低的模型。它以较小的体积和 100 万...的上下文窗口提供卓越的性能。",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-4.1 Nano (batch)",
			SummaryVal:      "对于需要低延迟的任务，GPT-4.",
			TagList:         []string{"chat", "fast", "file-input", "gpt", "nano", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1047576,
			MaxOutputVal:    32768,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-4.1-nano:batch"},
		},
		"openai/gpt-4.1:batch": {
			IDVal:           "openai/gpt-4.1:batch",
			NameVal:         "OpenAI: GPT-4.1 (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-4.1 is a flagship large language model optimized for advanced instruction following, real-world software engineering, and long-context reasoning. It supports a 1 million token context window and outperforms GPT-4o and...",
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-4.1 (batch)",
			SummaryVal:      "GPT-4.",
			TagList:         []string{"chat", "coding", "file-input", "gpt", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1047576,
			MaxOutputVal:    32768,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-4.1:batch"},
		},
		"openai/gpt-4o": {
			IDVal:           "openai/gpt-4o",
		...
		"openai/gpt-4o-mini:batch": {
			IDVal:           "openai/gpt-4o-mini:batch",
			NameVal:         "OpenAI: GPT-4o-mini (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-4o mini is OpenAI's newest model after [GPT-4 Omni](/models/openai/gpt-4o), supporting both text and image inputs with text outputs. As their most advanced small model, it is many multiples more affordable...",
			DescCNVal:       "GPT-4o mini 是 [GPT-4 Omni](/models/openai/gpt-4o) 之后的 OpenAI 最新模型，支持文本和图像输入及文本输出。作为其最先进的小型模型，它的成本更为低廉...",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-4o-mini (batch)",
			SummaryVal:      "GPT-4o mini 是 [GPT-4 Omni](/models/openai/gpt-4o) 之后的 OpenAI 最新模型，支持文本和图像输入及文本输出。",
			TagList:         []string{"chat", "file-input", "gpt", "mini", "structured-output", "tool-use", "vision"},
			ContextLenVal:   128000,
			MaxOutputVal:    16384,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-4o-mini:batch"},
		},
		...
		"openai/gpt-4o:batch": {
			IDVal:           "openai/gpt-4o:batch",
			NameVal:         "OpenAI: GPT-4o (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-4o (\"o\" for \"omni\") is OpenAI's latest AI model, supporting both text and image inputs with text outputs. It maintains the intelligence level of [GPT-4 Turbo](/models/openai/gpt-4-turbo) while being twice as...",
			DescCNVal:       "GPT-4o（\"o\" 代表 \"omni\"）是 OpenAI 的最新 AI 模型，支持文本和图像输入及文本输出。它在保持 [GPT-4 Turbo](/models/openai/gpt-4-turbo) 智能水平的同时，速度提升了一倍...",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-4o (batch)",
			SummaryVal:      "GPT-4o（\"o\" 代表 \"omni\"）是 OpenAI 的最新 AI 模型，支持文本和图像输入及文本输出。",
			TagList:         []string{"chat", "file-input", "gpt", "structured-output", "tool-use", "turbo", "vision"},
			ContextLenVal:   128000,
			MaxOutputVal:    16384,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-4o:batch"},
		},
		...
		"openai/gpt-5-codex:batch": {
			IDVal:           "openai/gpt-5-codex:batch",
			NameVal:         "OpenAI: GPT-5 Codex (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5-Codex is a specialized version of GPT-5 optimized for software engineering and coding workflows. It is designed for both interactive development sessions and long, independent execution of complex engineering tasks....",
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5 Codex (batch)",
			SummaryVal:      "GPT-5-Codex is a specialized version of GPT-5 optimized for software engineering and coding workflows.",
			TagList:         []string{"chat", "coding", "gpt", "structured-output", "tool-use", "vision"},
			ContextLenVal:   400000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5-codex:batch"},
		},
		"openai/gpt-5-image": {
		...
		"openai/gpt-5-mini:batch": {
			IDVal:           "openai/gpt-5-mini:batch",
			NameVal:         "OpenAI: GPT-5 Mini (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5 Mini is a compact version of GPT-5, designed to handle lighter-weight reasoning tasks. It provides the same instruction-following and safety-tuning benefits as GPT-5, but with reduced latency and cost....",
			DescCNVal:       "GPT-5 Mini 是 GPT-5 的紧凑版本，设计用于处理较轻量的推理任务。它提供与 GPT-5 相同的指令跟随和安全调优的好处，但延迟和成本降低...",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5 Mini (batch)",
			SummaryVal:      "GPT-5 Mini 是 GPT-5 的紧凑版本，设计用于处理较轻量的推理任务。",
			TagList:         []string{"chat", "coding", "file-input", "gpt", "mini", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   400000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5-mini:batch"},
		},
		"openai/gpt-5-nano": {
		...
		"openai/gpt-5-nano:batch": {
			IDVal:           "openai/gpt-5-nano:batch",
			NameVal:         "OpenAI: GPT-5 Nano (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5-Nano is the smallest and fastest variant in the GPT-5 system, optimized for developer tools, rapid interactions, and ultra-low latency environments. While limited in reasoning depth compared to its larger...",
			DescCNVal:       "GPT-5-Nano 是 GPT-5 系统中最小和最快的变体，针对开发工具、快速互动和超低延迟环境进行了优化。相比于更大的模型，其推理深度有限...",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5 Nano (batch)",
			SummaryVal:      "GPT-5-Nano 是 GPT-5 系统中最小和最快的变体，针对开发工具、快速互动和超低延迟环境进行了优化。",
			TagList:         []string{"chat", "fast", "file-input", "gpt", "nano", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   400000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5-nano:batch"},
		},
		"openai/gpt-5-pro": {
		...
		"openai/gpt-5-pro:batch": {
			IDVal:           "openai/gpt-5-pro:batch",
			NameVal:         "OpenAI: GPT-5 Pro (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5 Pro is OpenAI’s most advanced model, offering major improvements in reasoning, code quality, and user experience. It is optimized for complex tasks that require step-by-step reasoning, instruction following, and...",
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5 Pro (batch)",
			SummaryVal:      "GPT-5 Pro is OpenAI’s most advanced model, offering major improvements in reasoning, code quality, and user experience.",
			TagList:         []string{"chat", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   400000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5-pro:batch"},
		},
		"openai/gpt-5.1": {
		...
		"openai/gpt-5.1:batch": {
			IDVal:           "openai/gpt-5.1:batch",
			NameVal:         "OpenAI: GPT-5.1 (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5.1 is the latest frontier-grade model in the GPT-5 series, offering stronger general-purpose reasoning, improved instruction adherence, and a more natural conversational style compared to GPT-5. It uses adaptive reasoning...",
			DescCNVal:       "GPT-5.1 是 GPT-5 系列中最新的前沿级模型，提供比 GPT-5 更强的通用推理能力、改进的指令遵循性和更自然的对话风格。它采用自适应推理...",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.1 (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "file-input", "gpt", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   400000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.1:batch"},
		},
		"openai/gpt-5.2": {
		...
		"openai/gpt-5.2-pro:batch": {
			IDVal:           "openai/gpt-5.2-pro:batch",
			NameVal:         "OpenAI: GPT-5.2 Pro (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5.2 Pro is OpenAI’s most advanced model, offering major improvements in agentic coding and long context performance over GPT-5 Pro. It is optimized for complex tasks that require step-by-step reasoning,...",
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.2 Pro (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"agent", "chat", "coding", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   400000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.2-pro:batch"},
		},
		"openai/gpt-5.2:batch": {
			IDVal:           "openai/gpt-5.2:batch",
			NameVal:         "OpenAI: GPT-5.2 (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5.2 is the latest frontier-grade model in the GPT-5 series, offering stronger agentic and long context perfomance compared to GPT-5.1. It uses adaptive reasoning to allocate computation dynamically, responding quickly...",
			DescCNVal:       "GPT-5.2 是 GPT-5 系列中最新的前沿级模型，与 GPT-5.1 相比，提供更强的代理和长上下文表现。它使用自适应推理动态分配计算，快速响应...",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.2 (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"agent", "chat", "file-input", "gpt", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   400000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.2:batch"},
		},
		"openai/gpt-5.3-chat": {
		...
		"openai/gpt-5.4-mini:batch": {
			IDVal:           "openai/gpt-5.4-mini:batch",
			NameVal:         "OpenAI: GPT-5.4 Mini (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5.4 mini brings the core capabilities of GPT-5.4 to a faster, more efficient model optimized for high-throughput workloads. It supports text and image inputs with strong performance across reasoning, coding,...",
			DescCNVal:       "GPT-5.4 mini 将 GPT-5.4 的核心能力带入一个更快、更高效的模型，优化用于高吞吐量工作负载。它支持文本和图像输入，在推理、编码等方面具有强性能...",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.4 Mini (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "coding", "fast", "file-input", "gpt", "mini", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   400000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.4-mini:batch"},
		},
		"openai/gpt-5.4-nano": {
		...
		"openai/gpt-5.4-nano:batch": {
			IDVal:           "openai/gpt-5.4-nano:batch",
			NameVal:         "OpenAI: GPT-5.4 Nano (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5.4 nano is the most lightweight and cost-efficient variant of the GPT-5.4 family, optimized for speed-critical and high-volume tasks. It supports text and image inputs and is designed for low-latency...",
			DescCNVal:       "GPT-5.4 nano 是 GPT-5.4 系列中最轻量且成本效益最高的变体，针对对速度敏感和高容量的任务进行了优化。它支持文本和图像输入，并设计用于低延迟...",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.4 Nano (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "file-input", "gpt", "nano", "structured-output", "tool-use", "vision"},
			ContextLenVal:   400000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.4-nano:batch"},
		},
		"openai/gpt-5.4-pro": {
		...
		"openai/gpt-5.4-pro:batch": {
			IDVal:           "openai/gpt-5.4-pro:batch",
			NameVal:         "OpenAI: GPT-5.4 Pro (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5.4 Pro is OpenAI's most advanced model, building on GPT-5.4's unified architecture with enhanced reasoning capabilities for complex, high-stakes tasks. It features a 1M+ token context window (922K input, 128K...",
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.4 Pro (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.4-pro:batch"},
		},
		"openai/gpt-5.4:batch": {
			IDVal:           "openai/gpt-5.4:batch",
			NameVal:         "OpenAI: GPT-5.4 (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5.4 is OpenAI’s latest frontier model, unifying the Codex and GPT lines into a single system. It features a 1M+ token context window (922K input, 128K output) with support for...",
			DescCNVal:       "GPT-5.4 是 OpenAI 最新的前沿模型，将 Codex 和 GPT 系列整合为一个系统。它具有超过 1M 的上下文窗口（922K 输入，128K 输出），支持...",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.4 (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "coding", "file-input", "gpt", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.4:batch"},
		},
		"openai/gpt-5.5": {
		...
		"openai/gpt-5.5-pro:batch": {
			IDVal:           "openai/gpt-5.5-pro:batch",
			NameVal:         "OpenAI: GPT-5.5 Pro (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			...
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.5 Pro (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.5-pro:batch"},
		},
		"openai/gpt-5.5:batch": {
			IDVal:           "openai/gpt-5.5:batch",
			NameVal:         "OpenAI: GPT-5.5 (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5.5 is OpenAI’s frontier model designed for complex professional workloads, building on GPT-5.4 with stronger reasoning, higher reliability, and improved token efficiency on hard tasks. It features a 1M+ token...",
			DescCNVal:       "GPT-5.5 是 OpenAI 专为复杂专业工作负载设计的前沿模型，建立在 GPT-5.4 之上，具有更强的推理、更高的可靠性以及在困难任务上的改进的令牌效率。它具有超过 1M 的令牌...",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.5 (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.5:batch"},
		},
		"openai/gpt-5.6-luna": {
			...
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-luna"},
		},
		"openai/gpt-5.6-luna-pro": {
			IDVal:           "openai/gpt-5.6-luna-pro",
			NameVal:         "OpenAI: GPT-5.6 Luna Pro",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5.6 Luna Pro is the same underlying model as [GPT-5.6 Luna](https://openrouter.ai/openai/gpt-5.6-luna), served with `reasoning.mode` set to `pro` for higher-quality responses on complex tasks.\n\nLearn more in OpenAI's docs: https://developers.openai.com/api/docs/guides/reasoning#reasoning-mode",
			DescCNVal:       "GPT-5.6 Luna Pro与[GPT-5.6 Luna](https://openrouter.ai/openai/gpt-5.6-luna)具有相同的基础模型，`reasoning.mode`设置为`pro`，可在复杂任务中提供更高质量的响应。\n\n详细信息请查看OpenAI文档： https://developers.openai.com/api/docs/guides/reasoning#reasoning-mode",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.6 Luna Pro",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "coding", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-luna-pro"},
		},
		"openai/gpt-5.6-luna-pro:batch": {
			IDVal:           "openai/gpt-5.6-luna-pro:batch",
			NameVal:         "OpenAI: GPT-5.6 Luna Pro (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			...
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.6 Luna Pro (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "coding", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-luna-pro:batch"},
		},
		"openai/gpt-5.6-luna:batch": {
			IDVal:           "openai/gpt-5.6-luna:batch",
			NameVal:         "OpenAI: GPT-5.6 Luna (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			...
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.6 Luna (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"agent", "chat", "fast", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-luna:batch"},
		},
		"openai/gpt-5.6-sol": {
			...
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-sol"},
		},
		"openai/gpt-5.6-sol-pro": {
			IDVal:           "openai/gpt-5.6-sol-pro",
			NameVal:         "OpenAI: GPT-5.6 Sol Pro",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5.6 Sol Pro is the same underlying model as [GPT-5.6 Sol](https://openrouter.ai/openai/gpt-5.6-sol), served with `reasoning.mode` set to `pro` for higher-quality responses on complex tasks.\n\nLearn more in OpenAI's docs: https://developers.openai.com/api/docs/guides/reasoning#reasoning-mode",
			DescCNVal:       "GPT-5.6 Sol Pro与[GPT-5.6 Sol](https://openrouter.ai/openai/gpt-5.6-sol)具有相同的基础模型，`reasoning.mode`设置为`pro`，可在复杂任务中提供更高质量的响应。\n\n详细信息请查看OpenAI文档： https://developers.openai.com/api/docs/guides/reasoning#reasoning-mode",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.6 Sol Pro",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "coding", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-sol-pro"},
		},
		"openai/gpt-5.6-sol-pro:batch": {
			IDVal:           "openai/gpt-5.6-sol-pro:batch",
			NameVal:         "OpenAI: GPT-5.6 Sol Pro (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			...
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.6 Sol Pro (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "coding", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-sol-pro:batch"},
		},
		"openai/gpt-5.6-sol:batch": {
			IDVal:           "openai/gpt-5.6-sol:batch",
			NameVal:         "OpenAI: GPT-5.6 Sol (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			...
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.6 Sol (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"agent", "chat", "coding", "file-input", "gpt", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-sol:batch"},
		},
		"openai/gpt-5.6-terra": {
			...
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-terra"},
		},
		"openai/gpt-5.6-terra-pro": {
			IDVal:           "openai/gpt-5.6-terra-pro",
			NameVal:         "OpenAI: GPT-5.6 Terra Pro",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5.6 Terra Pro is the same underlying model as [GPT-5.6 Terra](https://openrouter.ai/openai/gpt-5.6-terra), served with `reasoning.mode` set to `pro` for higher-quality responses on complex tasks.\n\nLearn more in OpenAI's docs: https://developers.openai.com/api/docs/guides/reasoning#reasoning-mode",
			DescCNVal:       "GPT-5.6 Terra Pro与[GPT-5.6 Terra](https://openrouter.ai/openai/gpt-5.6-terra)具有相同的基础模型，`reasoning.mode`设置为`pro`，可在复杂任务中提供更高质量的响应。\n\n详细信息请查看OpenAI文档： https://developers.openai.com/api/docs/guides/reasoning#reasoning-mode",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.6 Terra Pro",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "coding", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-terra-pro"},
		},
		"openai/gpt-5.6-terra-pro:batch": {
			IDVal:           "openai/gpt-5.6-terra-pro:batch",
			NameVal:         "OpenAI: GPT-5.6 Terra Pro (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			...
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.6 Terra Pro (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"chat", "coding", "file-input", "gpt", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-terra-pro:batch"},
		},
		"openai/gpt-5.6-terra:batch": {
			IDVal:           "openai/gpt-5.6-terra:batch",
			NameVal:         "OpenAI: GPT-5.6 Terra (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			...
			DescCNVal:       "",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5.6 Terra (batch)",
			SummaryVal:      "GPT-5.",
			TagList:         []string{"agent", "chat", "coding", "file-input", "gpt", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   1050000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5.6-terra:batch"},
		},
		"openai/gpt-5:batch": {
			IDVal:           "openai/gpt-5:batch",
			NameVal:         "OpenAI: GPT-5 (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "GPT-5 is OpenAI’s most advanced model, offering major improvements in reasoning, code quality, and user experience. It is optimized for complex tasks that require step-by-step reasoning, instruction following, and accuracy...",
			DescCNVal:       "GPT-5 是 OpenAI 最先进的模型，在推理、代码质量和用户体验上实现了重大改进。它优化用于需要逐步推理、跟随指令和准确性的复杂任务...",
			FamilyVal:       "GPT",
			SeriesVal:       "GPT-5 (batch)",
			SummaryVal:      "GPT-5 是 OpenAI 最先进的模型，在推理、代码质量和用户体验上实现了重大改进。",
			TagList:         []string{"chat", "file-input", "gpt", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   400000,
			MaxOutputVal:    128000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"gpt-5:batch"},
		},
		"openai/gpt-audio": {
		...
		"openai/o1-pro:batch": {
			IDVal:           "openai/o1-pro:batch",
			NameVal:         "OpenAI: o1-pro (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "The o1 series of models are trained with reinforcement learning to think before they answer and perform complex reasoning. The o1-pro model uses more compute to think harder and provide...",
			DescCNVal:       "o1 系列模型通过强化学习训练，能够在回答前进行思考并执行复杂推理。o1-pro 模型使用更多的计算资源进行更深入思考，并提供...",
			FamilyVal:       "O1",
			SeriesVal:       "o1-pro (batch)",
			SummaryVal:      "o1 系列模型通过强化学习训练，能够在回答前进行思考并执行复杂推理。",
			TagList:         []string{"chat", "coding", "file-input", "o1", "pro", "reasoning", "structured-output", "vision"},
			ContextLenVal:   200000,
			MaxOutputVal:    100000,
			FeaturesVal:     CapChat | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"o1-pro:batch"},
		},
		"openai/o1:batch": {
			IDVal:           "openai/o1:batch",
			NameVal:         "OpenAI: o1 (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "The latest and strongest model family from OpenAI, o1 is designed to spend more time thinking before responding. The o1 model series is trained with large-scale reinforcement learning to reason...",
			DescCNVal:       "o1 是 OpenAI 最新的也是最强力的模型家族，旨在在回应前花费更多时间思考。o1 模型系列通过大规模强化学习训练以进行推理...",
			FamilyVal:       "O1",
			SeriesVal:       "o1 (batch)",
			SummaryVal:      "o1 是 OpenAI 最新的也是最强力的模型家族，旨在在回应前花费更多时间思考。",
			TagList:         []string{"chat", "file-input", "o1", "reasoning", "structured-output", "thinking", "tool-use", "vision"},
			ContextLenVal:   200000,
			MaxOutputVal:    100000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"o1:batch"},
		},
		"openai/o3": {
			IDVal:           "openai/o3",
			NameVal:         "OpenAI: o3",
		...
		"openai/o3-mini-high:batch": {
			IDVal:           "openai/o3-mini-high:batch",
			NameVal:         "OpenAI: o3 Mini High (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "OpenAI o3-mini-high is the same model as [o3-mini](/openai/o3-mini) with reasoning_effort set to high. o3-mini is a cost-efficient language model optimized for STEM reasoning tasks, particularly excelling in science, mathematics, and...",
			DescCNVal:       "OpenAI o3-mini-high 与 [o3-mini](/openai/o3-mini) 是同一模型，仅将 reasoning_effort 参数设置为 high。o3-mini 是一款专为 STEM 推理任务优化的成本高效型语言模型，在科学、数学和代码方面尤为出色...",
			FamilyVal:       "O3",
			SeriesVal:       "o3 Mini High (batch)",
			SummaryVal:      "OpenAI o3-mini-high 与 [o3-mini](/openai/o3-mini) 是同一模型，仅将 reasoning_effort 参数设置为 high。",
			TagList:         []string{"chat", "file-input", "mini", "o3", "reasoning", "structured-output", "tool-use"},
			ContextLenVal:   200000,
			MaxOutputVal:    100000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"o3-mini-high:batch"},
		},
		"openai/o3-mini:batch": {
			IDVal:           "openai/o3-mini:batch",
			NameVal:         "OpenAI: o3 Mini (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "OpenAI o3-mini is a cost-efficient language model optimized for STEM reasoning tasks, particularly excelling in science, mathematics, and coding. This model supports the `reasoning_effort` parameter, which can be set to...",
			DescCNVal:       "OpenAI o3-mini 是一款专为 STEM 推理任务优化的成本高效型语言模型，在科学、数学和代码方面尤为出色。该模型支持 `reasoning_effort` 参数，可设置为...",
			FamilyVal:       "O3",
			SeriesVal:       "o3 Mini (batch)",
			SummaryVal:      "OpenAI o3-mini 是一款专为 STEM 推理任务优化的成本高效型语言模型，在科学、数学和代码方面尤为出色。",
			TagList:         []string{"chat", "coding", "file-input", "mini", "o3", "reasoning", "structured-output", "tool-use"},
			ContextLenVal:   200000,
			MaxOutputVal:    100000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"o3-mini:batch"},
		},
		"openai/o3-pro": {
			IDVal:           "openai/o3-pro",
		...
		"openai/o3-pro:batch": {
			IDVal:           "openai/o3-pro:batch",
			NameVal:         "OpenAI: o3 Pro (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "The o-series of models are trained with reinforcement learning to think before they answer and perform complex reasoning. The o3-pro model uses more compute to think harder and provide consistently...",
			DescCNVal:       "",
			FamilyVal:       "O3",
			SeriesVal:       "o3 Pro (batch)",
			SummaryVal:      "The o-series of models are trained with reinforcement learning to think before they answer and perform complex reasoning.",
			TagList:         []string{"chat", "coding", "file-input", "o3", "pro", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   200000,
			MaxOutputVal:    100000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"o3-pro:batch"},
		},
		"openai/o3:batch": {
			IDVal:           "openai/o3:batch",
			NameVal:         "OpenAI: o3 (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "o3 is a well-rounded and powerful model across domains. It sets a new standard for math, science, coding, and visual reasoning tasks. It also excels at technical writing and instruction-following....",
			DescCNVal:       "",
			FamilyVal:       "O3",
			SeriesVal:       "o3 (batch)",
			SummaryVal:      "o3 is a well-rounded and powerful model across domains.",
			TagList:         []string{"chat", "coding", "file-input", "o3", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   200000,
			MaxOutputVal:    100000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"o3:batch"},
		},
		"openai/o4-mini": {
		...
		"openai/o4-mini-high:batch": {
			IDVal:           "openai/o4-mini-high:batch",
			NameVal:         "OpenAI: o4 Mini High (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "OpenAI o4-mini-high is the same model as [o4-mini](/openai/o4-mini) with reasoning_effort set to high. OpenAI o4-mini is a compact reasoning model in the o-series, optimized for fast, cost-efficient performance while retaining...",
			DescCNVal:       "",
			FamilyVal:       "O4",
			SeriesVal:       "o4 Mini High (batch)",
			SummaryVal:      "OpenAI o4-mini-high is the same model as [o4-mini](/openai/o4-mini) with reasoning_effort set to high.",
			TagList:         []string{"chat", "fast", "file-input", "mini", "o4", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   200000,
			MaxOutputVal:    100000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"o4-mini-high:batch"},
		},
		"openai/o4-mini:batch": {
			IDVal:           "openai/o4-mini:batch",
			NameVal:         "OpenAI: o4 Mini (batch)",
			ProviderVal:     "OpenAI",
			DeveloperVal:    "openai",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			DescVal:         "OpenAI o4-mini is a compact reasoning model in the o-series, optimized for fast, cost-efficient performance while retaining strong multimodal and agentic capabilities. It supports tool use and demonstrates competitive reasoning...",
			DescCNVal:       "",
			FamilyVal:       "O4",
			SeriesVal:       "o4 Mini (batch)",
			SummaryVal:      "OpenAI o4-mini is a compact reasoning model in the o-series, optimized for fast, cost-efficient performance while retaining strong multimodal and agentic capabilities.",
			TagList:         []string{"agent", "chat", "fast", "file-input", "mini", "o4", "reasoning", "structured-output", "tool-use", "vision"},
			ContextLenVal:   200000,
			MaxOutputVal:    100000,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityFileIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"o4-mini:batch"},
		},
		...
		"poolside/laguna-s-2.1": {
			...
			MaxOutputVal:    131072,
			FeaturesVal:     CapChat | CapFunctionCall | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"laguna-s-2.1"},
		},
		"poolside/laguna-s-2.1:free": {
			IDVal:           "poolside/laguna-s-2.1:free",
			NameVal:         "Poolside: Laguna S 2.1 (free)",
			ProviderVal:     "Poolside",
			DeveloperVal:    "Poolside",
			OfficialURLVal:  "",
			ModelCardURLVal: "https://huggingface.co/poolside/Laguna-S-2.1",
			...
			DescCNVal:       "Laguna S 2.1 是 [Poolside](<https://poolside.ai/>) 最新的编码代理模型。Laguna S 2.1 是一个118B参数总量的模型，具有8B活跃参数，在Terminal-Bench 2.1中得分70.2%并...",
			FamilyVal:       "Laguna",
			SeriesVal:       "Laguna S 2.1 (free)",
			SummaryVal:      "Laguna S 2.",
			TagList:         []string{"agent", "chat", "coding", "free", "laguna", "tool-use"},
			ContextLenVal:   262144,
			MaxOutputVal:    32768,
			FeaturesVal:     CapChat | CapFunctionCall | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"laguna-s-2.1:free"},
		},
		"poolside/laguna-xs-2.1": {
			...
			MaxOutputVal:    32768,
			FeaturesVal:     CapChat | CapFunctionCall | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"laguna-xs-2.1"},
		},
		"poolside/laguna-xs-2.1:free": {
			IDVal:           "poolside/laguna-xs-2.1:free",
			NameVal:         "Poolside: Laguna XS 2.1 (free)",
			ProviderVal:     "Poolside",
			DeveloperVal:    "Poolside",
			OfficialURLVal:  "",
			ModelCardURLVal: "https://huggingface.co/poolside/Laguna-XS-2.1",
			...
			DescCNVal:       "Laguna XS 2.1 是来自 [Poolside](https://poolside.ai/) 的最新编码代理模型，属于 33B-A3B 类别，比他们的 Laguna XS.2 模型（在 2026 年 4 月发布）更进了一步。它结合了...",
			FamilyVal:       "Laguna",
			SeriesVal:       "Laguna XS 2.1 (free)",
			SummaryVal:      "Laguna XS 2.",
			TagList:         []string{"agent", "chat", "coding", "free", "laguna", "tool-use"},
			ContextLenVal:   262144,
			MaxOutputVal:    32768,
			FeaturesVal:     CapChat | CapFunctionCall | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"laguna-xs-2.1:free"},
		},
		...
		"tencent/hy3:free": {
			IDVal:           "tencent/hy3:free",
			NameVal:         "Tencent: Hy3 (free)",
			ProviderVal:     "Tencent",
			DeveloperVal:    "tencent",
			OfficialURLVal:  "",
			ModelCardURLVal: "",
			...
			SeriesVal:       "Hy3 (free)",
			SummaryVal:      "Hy3 是来自腾讯的295B参数混合专家模型（21B活跃，192个专家，采用前8路由），旨在推理、代理工作流和现实世界的生产使用。",
			TagList:         []string{"agent", "chat", "free", "hy3", "pro", "reasoning", "structured-output", "tool-use"},
			ContextLenVal:   262144,
			MaxOutputVal:    262144,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"hy3:free"},
		},
		...
		"thinkingmachines/inkling:batch": {
			IDVal:           "thinkingmachines/inkling:batch",
			NameVal:         "Thinking Machines: Inkling (batch)",
			ProviderVal:     "Thinkingmachines",
			DeveloperVal:    "thinkingmachines",
			OfficialURLVal:  "",
			ModelCardURLVal: "https://huggingface.co/thinkingmachines/Inkling",
			...
			DescCNVal:       "",
			FamilyVal:       "Inkling",
			SeriesVal:       "Inkling (batch)",
			SummaryVal:      "Inkling is an open-weight multimodal mixture-of-experts model from Thinking Machines Lab, with 41B active parameters out of 975B total.",
			TagList:         []string{"agent", "audio-input", "chat", "coding", "inkling", "reasoning", "thinking", "tool-use", "vision"},
			ContextLenVal:   524288,
			MaxOutputVal:    0,
			FeaturesVal:     CapChat | CapFunctionCall | ModalityAudioIn | ModalityImageIn | ModalityTextIn | ModalityTextOut | CapMultimodal,
			AliasList:       []string{"inkling:batch"},
		},
		...
		"z-ai/glm-5.2:batch": {
			IDVal:           "z-ai/glm-5.2:batch",
			NameVal:         "Z.ai: GLM 5.2 (batch)",
			ProviderVal:     "Z-Ai",
			DeveloperVal:    "zai",
			OfficialURLVal:  "",
			ModelCardURLVal: "https://huggingface.co/zai-org/GLM-5.2",
			DescVal:         "GLM 5.2 is a large-scale reasoning model from Z.ai. It supports text input and output with a 1M-token context window, and is suited for long-horizon agent workflows, project-level software engineering,...",
			DescCNVal:       "",
			FamilyVal:       "GLM",
			SeriesVal:       "GLM 5.2 (batch)",
			SummaryVal:      "GLM 5.",
			TagList:         []string{"agent", "chat", "coding", "glm", "pro", "reasoning", "structured-output", "tool-use"},
			ContextLenVal:   512000,
			MaxOutputVal:    0,
			FeaturesVal:     CapChat | CapFunctionCall | CapJsonMode | ModalityTextIn | ModalityTextOut,
			AliasList:       []string{"glm-5.2:batch"},
		},
		"z-ai/glm-5v-turbo": {
	...
	aliasIndex = map[string]string{
		...
		"claude-fable-5:batch":                              "anthropic/claude-fable-5:batch",
		"claude-fable-latest":                               "~anthropic/claude-fable-latest",
		"claude-haiku-4.5":                                  "anthropic/claude-haiku-4.5",
		"claude-haiku-4.5:batch":                            "anthropic/claude-haiku-4.5:batch",
		"claude-haiku-latest":                               "~anthropic/claude-haiku-latest",
		"claude-opus-4":                                     "anthropic/claude-opus-4",
		"claude-opus-4.1":                                   "anthropic/claude-opus-4.1",
		"claude-opus-4.1:batch":                             "anthropic/claude-opus-4.1:batch",
		"claude-opus-4.5":                                   "anthropic/claude-opus-4.5",
		"claude-opus-4.5:batch":                             "anthropic/claude-opus-4.5:batch",
		"claude-opus-4.6":                                   "anthropic/claude-opus-4.6",
		"claude-opus-4.6-fast":                              "anthropic/claude-opus-4.6-fast",
		"claude-opus-4.6:batch":                             "anthropic/claude-opus-4.6:batch",
		"claude-opus-4.7":                                   "anthropic/claude-opus-4.7",
		"claude-opus-4.7-fast":                              "anthropic/claude-opus-4.7-fast",
		"claude-opus-4.7:batch":                             "anthropic/claude-opus-4.7:batch",
		"claude-opus-4.8":                                   "anthropic/claude-opus-4.8",
		"claude-opus-4.8-fast":                              "anthropic/claude-opus-4.8-fast",
		"claude-opus-4.8:batch":                             "anthropic/claude-opus-4.8:batch",
		"claude-opus-5":                                     "anthropic/claude-opus-5",
		"claude-opus-5-fast":                                "anthropic/claude-opus-5-fast",
		"claude-opus-5:batch":                               "anthropic/claude-opus-5:batch",
		"claude-opus-latest":                                "~anthropic/claude-opus-latest",
		"claude-sonnet-4":                                   "anthropic/claude-sonnet-4",
		"claude-sonnet-4.5":                                 "anthropic/claude-sonnet-4.5",
		"claude-sonnet-4.5:batch":                           "anthropic/claude-sonnet-4.5:batch",
		"claude-sonnet-4.6":                                 "anthropic/claude-sonnet-4.6",
		"claude-sonnet-4.6:batch":                           "anthropic/claude-sonnet-4.6:batch",
		"claude-sonnet-5":                                   "anthropic/claude-sonnet-5",
		"claude-sonnet-5:batch":                             "anthropic/claude-sonnet-5:batch",
		...
		"gemini-2.5-flash-lite:batch":                       "google/gemini-2.5-flash-lite:batch",
		"gemini-2.5-flash-preview-09-2025":                  "google/gemini-2.5-flash-preview-09-2025",
		"gemini-2.5-flash:batch":                            "google/gemini-2.5-flash:batch",
		"gemini-2.5-pro":                                    "google/gemini-2.5-pro",
		"gemini-2.5-pro-preview":                            "google/gemini-2.5-pro-preview",
		"gemini-2.5-pro-preview-05-06":                      "google/gemini-2.5-pro-preview-05-06",
		"gemini-2.5-pro:batch":                              "google/gemini-2.5-pro:batch",
		"gemini-3-flash-preview":                            "google/gemini-3-flash-preview",
		"gemini-3-flash-preview:batch":                      "google/gemini-3-flash-preview:batch",
		...
		"gemini-3.1-flash-lite:batch":                       "google/gemini-3.1-flash-lite:batch",
		"gemini-3.1-pro-preview":                            "google/gemini-3.1-pro-preview",
		"gemini-3.1-pro-preview-customtools":                "google/gemini-3.1-pro-preview-customtools",
		"gemini-3.1-pro-preview:batch":                      "google/gemini-3.1-pro-preview:batch",
		"gemini-3.5-flash":                                  "google/gemini-3.5-flash",
		"gemini-3.5-flash-lite":                             "google/gemini-3.5-flash-lite",
		"gemini-3.5-flash-lite:batch":                       "google/gemini-3.5-flash-lite:batch",
		"gemini-3.5-flash:batch":                            "google/gemini-3.5-flash:batch",
		"gemini-3.6-flash":                                  "google/gemini-3.6-flash",
		"gemini-3.6-flash:batch":                            "google/gemini-3.6-flash:batch",
		...
		"glm-5.2:batch":                                     "z-ai/glm-5.2:batch",
		...
		"gpt-3.5-turbo:batch":                               "openai/gpt-3.5-turbo:batch",
		"gpt-4":                                             "openai/gpt-4",
		"gpt-4-0314":                                        "openai/gpt-4-0314",
		"gpt-4-1106-preview":                                "openai/gpt-4-1106-preview",
		"gpt-4-turbo":                                       "openai/gpt-4-turbo",
		"gpt-4-turbo-preview":                               "openai/gpt-4-turbo-preview",
		"gpt-4-turbo:batch":                                 "openai/gpt-4-turbo:batch",
		"gpt-4.1":                                           "openai/gpt-4.1",
		"gpt-4.1-mini":                                      "openai/gpt-4.1-mini",
		"gpt-4.1-mini:batch":                                "openai/gpt-4.1-mini:batch",
		"gpt-4.1-nano":                                      "openai/gpt-4.1-nano",
		"gpt-4.1-nano:batch":                                "openai/gpt-4.1-nano:batch",
		"gpt-4.1:batch":                                     "openai/gpt-4.1:batch",
		...
		"gpt-4o-mini:batch":                                 "openai/gpt-4o-mini:batch",
		"gpt-4o-search-preview":                             "openai/gpt-4o-search-preview",
		"gpt-4o:batch":                                      "openai/gpt-4o:batch",
		"gpt-4o:extended":                                   "openai/gpt-4o:extended",
		"gpt-5":                                             "openai/gpt-5",
		"gpt-5-chat":                                        "openai/gpt-5-chat",
		"gpt-5-codex":                                       "openai/gpt-5-codex",
		"gpt-5-codex:batch":                                 "openai/gpt-5-codex:batch",
		"gpt-5-image":                                       "openai/gpt-5-image",
		"gpt-5-image-mini":                                  "openai/gpt-5-image-mini",
		"gpt-5-mini":                                        "openai/gpt-5-mini",
		"gpt-5-mini:batch":                                  "openai/gpt-5-mini:batch",
		"gpt-5-nano":                                        "openai/gpt-5-nano",
		"gpt-5-nano:batch":                                  "openai/gpt-5-nano:batch",
		"gpt-5-pro":                                         "openai/gpt-5-pro",
		"gpt-5-pro:batch":                                   "openai/gpt-5-pro:batch",
		"gpt-5.1":                                           "openai/gpt-5.1",
		"gpt-5.1-chat":                                      "openai/gpt-5.1-chat",
		"gpt-5.1-codex":                                     "openai/gpt-5.1-codex",
		"gpt-5.1-codex-max":                                 "openai/gpt-5.1-codex-max",
		"gpt-5.1-codex-mini":                                "openai/gpt-5.1-codex-mini",
		"gpt-5.1:batch":                                     "openai/gpt-5.1:batch",
		"gpt-5.2":                                           "openai/gpt-5.2",
		"gpt-5.2-chat":                                      "openai/gpt-5.2-chat",
		"gpt-5.2-codex":                                     "openai/gpt-5.2-codex",
		"gpt-5.2-pro":                                       "openai/gpt-5.2-pro",
		"gpt-5.2-pro:batch":                                 "openai/gpt-5.2-pro:batch",
		"gpt-5.2:batch":                                     "openai/gpt-5.2:batch",
		"gpt-5.3-chat":                                      "openai/gpt-5.3-chat",
		"gpt-5.3-codex":                                     "openai/gpt-5.3-codex",
		"gpt-5.4":                                           "openai/gpt-5.4",
		"gpt-5.4-image-2":                                   "openai/gpt-5.4-image-2",
		"gpt-5.4-mini":                                      "openai/gpt-5.4-mini",
		"gpt-5.4-mini:batch":                                "openai/gpt-5.4-mini:batch",
		"gpt-5.4-nano":                                      "openai/gpt-5.4-nano",
		"gpt-5.4-nano:batch":                                "openai/gpt-5.4-nano:batch",
		"gpt-5.4-pro":                                       "openai/gpt-5.4-pro",
		"gpt-5.4-pro:batch":                                 "openai/gpt-5.4-pro:batch",
		"gpt-5.4:batch":                                     "openai/gpt-5.4:batch",
		"gpt-5.5":                                           "openai/gpt-5.5",
		"gpt-5.5-pro":                                       "openai/gpt-5.5-pro",
		"gpt-5.5-pro:batch":                                 "openai/gpt-5.5-pro:batch",
		"gpt-5.5:batch":                                     "openai/gpt-5.5:batch",
		"gpt-5.6-luna":                                      "openai/gpt-5.6-luna",
		"gpt-5.6-luna-pro":                                  "openai/gpt-5.6-luna-pro",
		"gpt-5.6-luna-pro:batch":                            "openai/gpt-5.6-luna-pro:batch",
		"gpt-5.6-luna:batch":                                "openai/gpt-5.6-luna:batch",
		"gpt-5.6-sol":                                       "openai/gpt-5.6-sol",
		"gpt-5.6-sol-pro":                                   "openai/gpt-5.6-sol-pro",
		"gpt-5.6-sol-pro:batch":                             "openai/gpt-5.6-sol-pro:batch",
		"gpt-5.6-sol:batch":                                 "openai/gpt-5.6-sol:batch",
		"gpt-5.6-terra":                                     "openai/gpt-5.6-terra",
		"gpt-5.6-terra-pro":                                 "openai/gpt-5.6-terra-pro",
		"gpt-5.6-terra-pro:batch":                           "openai/gpt-5.6-terra-pro:batch",
		"gpt-5.6-terra:batch":                               "openai/gpt-5.6-terra:batch",
		"gpt-5:batch":                                       "openai/gpt-5:batch",
		...
		"inkling:batch":                                     "thinkingmachines/inkling:batch",
		...
		"kimi-k2.7-code:batch":                              "moonshotai/kimi-k2.7-code:batch",
		...
		"ling-3.0-tiny:free":                                "inclusionai/ling-3.0-tiny:free",
		...
		"minimax-m3:batch":                                  "minimax/minimax-m3:batch",
		...
		"nemotron-3-ultra-550b-a55b:batch":            "nvidia/nemotron-3-ultra-550b-a55b:batch",
		...
		"o1-pro:batch":                                "openai/o1-pro:batch",
		"o1:batch":                                    "openai/o1:batch",
		"o3":                                          "openai/o3",
		"o3-deep-research":                            "openai/o3-deep-research",
		"o3-mini":                                     "openai/o3-mini",
		"o3-mini-high":                                "openai/o3-mini-high",
		"o3-mini-high:batch":                          "openai/o3-mini-high:batch",
		"o3-mini:batch":                               "openai/o3-mini:batch",
		"o3-pro":                                      "openai/o3-pro",
		"o3-pro:batch":                                "openai/o3-pro:batch",
		"o3:batch":                                    "openai/o3:batch",
		"o4-mini":                                     "openai/o4-mini",
		"o4-mini-deep-research":                       "openai/o4-mini-deep-research",
		"o4-mini-high":                                "openai/o4-mini-high",
		"o4-mini-high:batch":                          "openai/o4-mini-high:batch",
		"o4-mini:batch":                               "openai/o4-mini:batch",
