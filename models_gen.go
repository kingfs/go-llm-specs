...
// Generated at: 2026-04-22T04:36:24Z
...
func init() {
	staticRegistry = map[string]*modelData{
		...
		"meta-llama/llama-guard-4-12b:free": {
			...
			SummaryVal:    "Llama Guard 4 is a Llama 4 Scout-derived multimodal pretrained model, fine-tuned for content safety classification.",
		...
		"openrouter/elephant-alpha": {
			...
			FamilyVal:     "Elephant",
			SeriesVal:     "Elephant",
			SummaryVal:    "Elephant Alpha is a 100B-parameter text model focused on intelligence efficiency, delivering strong reasoning performance while minimizing token usage.",
		...
		"openrouter/pareto-code": {
			...
			SummaryVal:    "The Pareto Router is a way to have OpenRouter always pick a strong coding model for your needs without committing to a specific one.",
		...
		"~anthropic/claude-opus-latest": {
			...
			SummaryVal:    "This model always redirects to the latest model in the Claude Opus family.",
